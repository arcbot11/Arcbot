...
export const metadata: Metadata = pageMetadata("/privacy", "How Argos Bot collects, uses, shares, and protects information.");

const sections: LegalSection[] = [
  { title: "About this policy", paragraphs: ["This Privacy Policy explains how Argos Bot collects, uses, shares, and protects information when you visit the Argos Bot website, connect an X account, use an Argos Bot wallet, submit commands, or otherwise use our services.", "Questions or privacy requests may be sent to Argos Bot support."] },
  ...
  { title: "How information is shared", paragraphs: ["Argos Bot does not sell personal information. Information may be provided to infrastructure and service providers where needed to operate the service, process your instructions, prevent abuse, or comply with law."], bullets: ["X and authentication providers.", "Wallet infrastructure, blockchain networks, RPC providers, smart contracts, and block explorers.", "Hosting, database, security, analytics, AI, market-data, market-data providers."] },
...
export default function PrivacyPage() { return <LegalDocument eyebrow="Argos Bot legal" title="Privacy Policy" summary="How Argos Bot handles information across its website, X features, wallets, and related services." sections={sections} />; }
