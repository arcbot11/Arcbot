...
export default function PrivacyPage() { return <LegalDocument eyebrow="Arc Bot legal" title="Privacy Policy" summary="How Arc Bot handles information across its website, X features, wallets, and related services." sections={sections} />; }
