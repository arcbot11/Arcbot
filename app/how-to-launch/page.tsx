...
const parameters = [
  ...
  ["Developer buy", "Buy some of your token as part of the launch, or enter zero to skip it. Enter a USDC amount, or a dollar value if paired with ARGUS, ARCASH, EURC, cirBTC, WETH, or XAUM. Hold enough of the chosen asset in your wallet. Network fees are paid separately in Arc USDC.", "USDC pair: 25 USDC · Other pair: $25 worth of the paired asset · No dev buy: 0"],
  ...
  ["Paired asset", "Your token trades against USDC by default. You can instead choose ARGUS, ARCASH, EURC, cirBTC, WETH, or XAUM. This is what people spend to buy your token and receive when selling it. Hold this asset if you want an initial buy.", "Pair with ARGUS · Pair with ARCASH · Pair with EURC · Pair with cirBTC · Pair with WETH · Pair with XAUM"],
