...
const commands = [
  ...
  { command: "buy", description: "Buy a Arc token" },
  { command: "sell", description: "Sell a Arc token" },
  ...
  { command: "fees", description: "Claim creator fees" },
  { command: "help", description: "See everything Arc Bot can do" },
