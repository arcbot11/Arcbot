...
it.each(["buy $20", "and buy $20", "and buy $20 please!", "purchase $20", "buy $20 worth", "and buy $20 @ArcBot"])("accepts trailing %s", suffix => {
 const text = `@ArcBot launch Ryuroobin ticker RRB ${suffix}`;
