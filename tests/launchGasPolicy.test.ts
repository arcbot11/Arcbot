...
const terms={requestId:"test",index:0,kind:"launch",input,preview:{creator:address,fingerprint:launchFingerprint({owner,address},input),tokenSalt:toHex(1,{size:32}),hookSalt:toHex(2,{size:32})}} as unknown as LaunchStepTerms;
