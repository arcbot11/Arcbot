...
const post = `Hey @ArctosBot, launch "Arctos Bot", ticker $ARCBOT, X: www.x.com/arcbot, website: www.arcbot.invalid, dev buy: $100, description "Swap, sell, and launch on Argus with just one X post."`;
