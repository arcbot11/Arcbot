...
it("does not use an arbitrary GET wallet query from browser clients",async()=>{await GET(new NextRequest(`https://www.argosbot.io/api/wallet/fees?wallet=${token}`));expect(mock.tokens).toHaveBeenCalledWith(wallet,expect.any(Object));});
