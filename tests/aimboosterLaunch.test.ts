...
export const aimboosterPost = "@ArctosBot hey @ArctosBot launch token name aimbooster ticker is booster. this token create for boosting every project with aim to get 100% boost. use assign fees to @mengdelet";
