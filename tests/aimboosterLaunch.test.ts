...
export const aimboosterPost = "@ArcBot hey @ArcBot launch token name aimbooster ticker is booster. this token create for boosting every project with aim to get 100% boost. use assign fees to @mengdelet";
