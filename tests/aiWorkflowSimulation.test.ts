...
const scenarios: Scenario[] = [
  ...
  { post: "hey @ArcBot — what all can u help me with?", expected: { kind: "help", topic: "capabilities" } },
  ...
  { post: "yo what commands does @ArcBot understand", expected: { kind: "help", topic: "capabilities" } },
  ...
  { post: "@ArcBot buy $100 of $ARCBOT", expected: { kind: "command", operation: "buy", fields: { amount: "100", unit: "usd", token: "ARCBOT" } } },
  ...
  { post: "launch Arc Bot ticker ARCBOT pair with MSFT dev buy $100", expected: { kind: "command", operation: "launch", fields: { name: "Arc Bot", symbol: "ARCBOT", pairToken: "MSFT", devBuy: { amount: "100", unit: "usd" } } } },
  { post: "launch Arc Bot ticker $ARCBOT paired with SNDK and dev buy 0.02 ETH", expected: { kind: "command", operation: "launch", fields: { name: "Arc Bot", symbol: "ARCBOT", pairToken: "SNDK", devBuy: { amount: "0.02", unit: "eth" } } } },
  { post: "deploy Arc Bot ticker ARCBOT against MSFT with a 4 MSFT developer buy", expected: { kind: "command", operation: "launch", fields: { name: "Arc Bot", symbol: "ARCBOT", pairToken: "MSFT", devBuy: { amount: "4", unit: "pair" } } } },
  { post: "Launch Arc Bot $ARCBOT, pair asset TSLA, dev buy $75, website arcbot.invalid", expected: { kind: "command", operation: "launch", fields: { name: "Arc Bot", symbol: "ARCBOT", pairToken: "TSLA", website: "https://arcbot.invalid", devBuy: { amount: "75", unit: "usd" } } } },
  ...
  { post: "launch Arc Bot ticker ARCBOT pair MSFT dev buy", expected: { kind: "command", operation: "launch", fields: { name: "Arc Bot", symbol: "ARCBOT", pairToken: "MSFT" } } },
  ...
  { post: "swap $25 into MSFT and launch Arc Bot ticker ARCBOT", expected: { kind: "unknown_wallet" } },
  { post: "claim fees", expected: { kind: "command", operation: "claim_fees" } },
