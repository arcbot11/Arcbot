...
let cookie:string;
beforeEach(()=>{vi.useFakeTimers();vi.setSystemTime(new Date("2026-09-10T00:00:00Z"));for(const [k,v]of Object.entries({WEB_AUTH_SECRET:secret,X_OAUTH_CLIENT_ID:"client",NEXT_PUBLIC_SITE_URL:"https://www.arcchainbot.io",NEXT_PUBLIC_CONVEX_URL:"https://test.convex.cloud"}))vi.stubEnv(k,v);cookie=createWebWalletSession("0x1111111111111111111111111111111111111111","123","tester",secret);});
