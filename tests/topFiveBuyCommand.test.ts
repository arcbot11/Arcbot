...
describe("private top-five Arctos Bot buy command", () => {
  it("accepts only the two narrow command forms with harmless case and punctuation changes", async () => {
    ...
    expect(parseWalletCommand("Buy $25 each of the top 5 Arctos Bot tokens.")).toEqual(buy);
    expect(parseWalletCommand("@ArctosBot BUY AND BURN $12.50 OF EACH OF THE TOP 5 ARCTOS BOT TOKENS!!!")).toEqual(burn);
    await expect(parseXWalletIntent("@ArctosBot buy and burn $12.50 each of the top 5 Arctos Bot tokens", false))
  ...
  it.each([
    ...
    "please buy $10 each of the top 5 Arctos Bot tokens",
    "buy $10 of the top 5 Arctos Bot tokens",
    "buy $10 each of five Arctos Bot tokens",
    "buy and destroy $10 each of the top 5 Arctos Bot tokens",
    "buy and burn 0.01 ETH each of the top 5 Arctos Bot tokens",
    "buy and burn $10 each of the top 10 Arctos Bot tokens",
    "if you can, buy $10 each of the top 5 Arctos Bot tokens",
