...
describe("fixed Arctos Bot configuration",()=>{
 ...
 it("pins X identity despite old environment overrides",()=>{vi.stubEnv('X_BOT_USERNAME','OldBot');vi.stubEnv('NEXT_PUBLIC_ARCBOT_X_URL','https://x.com/OldBot');expect(xBotUsername()).toBe('ArctosBot');expect(brand.xUrl).toBe('https://x.com/ArctosBot');});
