...
A launch creates the explicitly named token. An optional initial or developer buy and a reward split belong to that single launch, not separate trading commands. Launch pairs are USDC by default, ARGUS, ARCASH, EURC, cirBTC, WETH, or XAUM. Questions about launching receive launch help.
