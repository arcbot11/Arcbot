  ...
  return <div className="otc-workspace">
    ...
    <div className="otc-single">
      ...
      {formOpen&&<section className="otc-form-panel" id="otc-order-form">
        ...
        {!session?.authenticated&&<p className="otc-notice"><Link href="/wallet/sign-in?returnTo=/otc">Connect your account ↗</Link> to create a listing or trade. Base actions are website only.</p>}
